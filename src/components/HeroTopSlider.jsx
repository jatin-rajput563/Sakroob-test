    ...
    <>
      <Marquee className="max-w-[1920px] mx-auto pt-[27px]">
        {MARQUE_DATA.map((item, index) => (
          <div
            key={index}
            className="flex gap-3 items-center text-[#112D49] min-w-[159px] sm:min-w-[180px] md:w-[207px] h-[69px] sm:h-[80px] md:h-[91px] border border-[#E7EAED] p-3 sm:p-4 rounded-lg mx-1 hover:shadow-2xl transition-all duration-300 ease-in-linear cursor-pointer"
          >
